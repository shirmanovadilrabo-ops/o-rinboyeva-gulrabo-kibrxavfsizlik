...
flowchart TD
    ...
    B{Main modulmi?}
    C[Foydalanuvchidan xabar olish]
    D[make_signature funksiyasini chaqirish]
    E[Yopiq kalitni fayldan oqish]
    F[Xabarni SHA256 bilan imzolash]
    G[Imzoni HEX formatga aylantirish]
    H[Imzoni ekranga chiqarish]
    Z([Tugash])
```
